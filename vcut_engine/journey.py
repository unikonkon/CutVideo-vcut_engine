...
def cues(data, man):
    ...
    **คลิปเป็นตัวบอกว่า "เริ่มเมื่อไร" เท่านั้น ความยาวเป็นวินาทีในหนัง**
    ...
    ซับจากบทพูดตัดช่วงของตัวเองให้พอดีกับคลิปที่มันเกาะอยู่ เพราะคำที่พูดในช็อต
    ต้องหายไปพร้อมช็อตนั้น (ของที่คนวางเองใช้กฎเดียวกับแผนที่แล้ว — ดู
    fxtext.item_spans)  แผนที่ไม่ใช่แบบนั้น มันเป็น
