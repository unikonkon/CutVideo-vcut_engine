...
def _entries(ctx):
    return {
        ...
        "compose": [
            ...
            # หกแบบของหน้าเว็บ 3 ขั้น — EDL + ไฟล์ตัวอย่างต่อแบบ ชั้นแต่งที่แก้ไว้
            # รายแบบก็อยู่ในนี้ (ดู variants._stash) จึงติดธงอันตราย
            ("variants", "แบบที่ตัดไว้หลายแบบ (30/45/60 วิ …)", [ctx.work / "variants"],
             "ตัดใหม่ทุกแบบ (~นาที) · ชั้นแต่งที่แก้รายแบบหายด้วย", True),
        ],
        "fx": [
