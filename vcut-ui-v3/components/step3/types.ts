...
// สำเนาจาก vcut-ui/components/panels/types.ts — โครง draft ของ fx/ซับ ต้องตรงกับ
// ของเดิมเป๊ะ เพราะ payload ที่ POST กลับเอนจิน (saveFx/saveCaptions) ใช้ทรงนี้

/** state กลางของ fx ที่ store ถืออยู่ — แผงแก้และเลนบนไทม์ไลน์ใช้ก้อนเดียวกัน */
...
export type FxDraft = NonNullable<FxStore["draft"]>;
...
/** บรรทัดบทพูดที่อยู่ในหนังจริง — store คิดมาให้แล้ว จากบทพูดที่ถอดไว้ + ไทม์ไลน์
 *
